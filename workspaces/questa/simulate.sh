...
vcom -2008 -work osvvm ../../model/vhdl/packages/os-vvm/SortListPkg_int.vhd \
	../../model/vhdl/packages/os-vvm/RandomBasePkg.vhd \
	../../model/vhdl/packages/os-vvm/RandomPkg.vhd \
	../../model/vhdl/packages/os-vvm/CoveragePkg.vhd \
	| tee -ai ./simulate.log;

#vcom -2008 -work tauhop ../../pkg-types.vhdl \
vcom -2008 -work tauhop ../../model/vhdl/packages/pkg-tlm.vhdl \
	../../model/vhdl/packages/pkg-fifo-tlm.vhdl \
	../../model/vhdl/fifo.vhdl \
	| tee -ai ./simulate.log;

vcom -2008 -work work ../../tester/tb.vhdl \
	| tee -ai ./simulate.log;
...
then echo "Errors exist. Refer simulate.log for more details. Exiting."; exit;
	...
	vsim -t ps -do ./waves.do -voptargs="+acc" "work.testbench(simulation)";
